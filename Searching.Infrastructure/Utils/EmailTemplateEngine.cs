...
public static class EmailTemplateEngine
{
  ...
  public static string OtpEmail(string senderName, string otp)
  {
    var html = $@"
        <head>
                      ...
                      <td style='text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 70px;'>
                        ...
                        <div aria-labelledby='mj-column-per-100' class='mj-column-per-100 outlook-group-fix' style='vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;'>
                          <table role='presentation' cellpadding='0' cellspacing='0' width='100%' border='0'>
                            ...
                            <tbody>
                              <tr>
                                <td style='display:block;width:60%;margin:30px auto;background-color:#7389da;color:#fff;border-radius:40px;padding:20px;text-align:center;font-size:36px;letter-spacing:10px;box-shadow:0px 7px 22px 0px rgba(0, 0, 0, 0.1)'>
                                  <div  class='c-email__code'>
                                  <span style='font-size=1.5rem;font-weight:bold;' class='c-email__code__text'>{otp}</span>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
